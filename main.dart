...
var secret =
    '98c3cbd9c87.....f538630240'; // Your API Key
var jwt =''; // JWT generated by client
...
Future<void> main() async {
  client
      ...
      // .setJWT(jwt) //Enable this to test account with JWT
      .setSelfSigned(status: true); //Do not use this in production

  //testing account with JWT
  // testAccountWithJWT(); //setJWT and enable this to test JWT in action
...
Future testAccountWithJWT() async {
  ...
  try {
    ...
    print(res1.data);
    final res2 = await account.getSessions();
    print(res2.data);
    final res3 = await account.getLogs();
    print(res3.data);
    final res4 = await account.updatePrefs(prefs: {"data": "bata"});
    print(res4.data);
    final res5 = await account.getPrefs();
    print(res5.data);
